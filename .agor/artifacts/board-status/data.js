export const LAST_UPDATED = "2026-07-16 12:15 IDT";
...
export const WORKTREES = [
  ...
  },
  {
    ...
    status: "✅ #1667 ALL CI PASS — run 29402877354 COMPLETE. OPEN + MERGEABLE + reviewDecision:\"\". Awaiting formal reviewer APPROVE to merge. Unchanged at 12:15 IDT Jul 16.",
    blockedOn: null,
    blockedType: "active",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f6a27c0727945a40615a2/",
    sessionLabel: "advance heartbeat 12:15 IDT Jul 16 — jn-5891 NEW; #1638 e2e-api FAIL; 0 merges; 6 Jira mismatches",
    recentSessions: [
      {
    ...
    lastActive: "2026-07-16 12:15 IDT",
  },
  {
    ticket: "JN-5872",
    ...
    status: "🔴 CI RUN 29411650412 COMPLETE — ALL-CHECKS FAIL. pre-commit FAIL. Other checks pass (e2e-smoke ✅, e2e-api ✅, integration ✅, tox ✅, nox ✅). OPEN + MERGEABLE. Action: fix pre-commit failure. Unchanged at 12:15 IDT Jul 16.",
  ...
  },
  {
    ...
    pr: null,
    prUrl: null,
    status: "🆕 NEW worktree (Jul 16). JN-5891: 'Increase GuideLLM max_seconds default from 600 to 1200.' Backlog, unassigned. No PR yet.",
    blockedOn: "No PR yet — recently started",
    blockedType: "active",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f6a27c0727945a40615a2/",
    sessionLabel: "advance heartbeat 12:15 IDT Jul 16 — discovered new worktree",
    recentSessions: [
      {
        sessionId: "019f6a27c0727945a40615a2",
        url: "http://127.0.0.1:3030/ui/s/019f6a27c0727945a40615a2/",
        title: "advance heartbeat 12:15 IDT Jul 16 — discovered new worktree",
        status: "running",
        timestamp: "2026-07-16 12:15 IDT",
        outputFile: null,
      },
...
export const ALERTS = [
  ...
  {
    level: "red",
    message: "🔴 #1638 (JN-5725, off-board): run 29485314694 (11:57 IDT) COMPLETED FAIL — e2e-api ❌, e2e-tests ❌, all-checks ❌. Run 29485473923 (11:59 IDT) in_progress at 12:15 IDT. e2e-smoke stuck issue resolved (SKIPPED in new run). Monitor run 29485473923.",
  },
  {
    level: "yellow",
    message: "🆕 jn-5891-max-seconds-1200 (JN-5891): NEW worktree in Code zone (Jul 16). 'Increase GuideLLM max_seconds default from 600 to 1200.' Backlog, unassigned. No PR yet.",
  },
  {
    level: "red",
