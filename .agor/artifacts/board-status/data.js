export const LAST_UPDATED = "2026-07-30 10:00 IDT (daily external sync)";
...
export const WORKTREES = [
  {
    ...
    blockedType: "active",
    sessionUrl: null,
    sessionLabel: "daily external sync 10:00 IDT Jul 30",
    recentSessions: [],
  ...
  },
  {
    ...
    sessionLabel: "daily external sync 10:00 IDT Jul 30",
    recentSessions: [],
    lastActive: "2026-07-27 12:54 IDT",
  },
  {
    ticket: "AIPCC-27645",
    ...
    status: "🔴 **CHANGES_REQUESTED by MenD32**. CI (run 30438043057): nox ✅, e2e-smoke ✅, e2e-api ✅, tox ✅; **e2e-product ❌**; pre-commit ❌, JIRA Assoc ❌. CI unchanged from Jul 29. **Action: Address reviewer feedback + fix pre-commit + investigate e2e-product.**",
    blockedOn: "CHANGES_REQUESTED — address reviewer feedback + fix pre-commit + e2e-product ❌",
    blockedType: "active",
    sessionUrl: null,
    sessionLabel: "daily external sync 10:00 IDT Jul 30 — CI unchanged",
    recentSessions: [],
    lastActive: "2026-07-30 10:00 IDT",
  },
  {
...
export const MERGED = [
  ...
  },
  {
    ...
    title: "docs(jbenchmark): add app-level AGENTS.md with benchmark platform context",
    pr: "#1658",
    prUrl: "https://github.com/Jounce-IO/jounce/pull/1658",
    mergedDate: "2026-07-14",
    note: "Merged 13:29 IDT Jul 14. Jira → needs Done.",
  },
  {
    ticket: "JN-5877",
    ...
    note: "Merged 15:16 IDT Jul 13. Jira → needs Done.",
  },
  {
    ticket: "JN-5874",
    ticketUrl: "https://redhat.atlassian.net/browse/JN-5874",
    title: "fix(helm): add missing image.tag entries to values-prd.yaml",
    pr: "#1662",
    prUrl: "https://github.com/Jounce-IO/jounce/pull/1662",
    mergedDate: "2026-07-13",
    note: "Merged 12:10 IDT Jul 13. Jira → needs Done.",
  },
  {
    ticket: "JN-5401",
    ...
    note: "Merged 17:12 IDT Jul 12. Jira → needs Done.",
  },
  {
    ticket: "JN-5827",
    ...
    mergedDate: "2026-07-12",
    note: "Merged 14:27 IDT Jul 12. Jira → needs Done.",
  },
];
...
export const ALERTS = [
  ...
  {
    level: "yellow",
    message: "📋 Jira sync (Jul 30): AIPCC-23647, 23857, 23788 now Closed — removed from active sprint list.",
  },
];
