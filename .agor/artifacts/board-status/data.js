export const LAST_UPDATED = "2026-07-13 00:00 IDT";
...
export const WORKTREES = [
  ...
  // jn-5401-runner-subcommands MERGED + ARCHIVED — moved to MERGED array below
  {
    ...
    sessionLabel: "heartbeat 00:00 IDT Jul 13 — pre-commit ❌ UNCHANGED",
    recentSessions: [
      {
  ...
  },
  {
    ...
    status: "🆕 e2e-smoke NOW ✅ PASSING (was PENDING) — only pre-commit ❌ remains. REVIEW_REQUIRED + MERGEABLE. Fix pre-commit → merge.",
    blockedOn: "pre-commit ❌ (run 29204508309) — e2e-smoke ✅ now passing",
    blockedType: "blocked",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f582169aa7dd49aa06a4c/",
    sessionLabel: "heartbeat 00:00 IDT Jul 13 — e2e-smoke ✅ NOW PASSING; only pre-commit ❌",
    recentSessions: [
      {
        sessionId: "019f582169aa7dd49aa06a4c",
        url: "http://127.0.0.1:3030/ui/s/019f582169aa7dd49aa06a4c/",
  ...
  },
  {
    ...
    blockedType: "blocked",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f582169aa7dd49aa06a4c/",
    sessionLabel: "heartbeat 00:00 IDT Jul 13 — CONFLICTING+CHANGES_REQUESTED UNCHANGED",
    recentSessions: [
      {
        sessionId: "019f582169aa7dd49aa06a4c",
        url: "http://127.0.0.1:3030/ui/s/019f582169aa7dd49aa06a4c/",
