export const LAST_UPDATED = "2026-07-14 11:00 IDT";
...
export const WORKTREES = [
  ...
  },
  {
    ...
    sessionLabel: "heartbeat 11:00 IDT Jul 14 — #1656 DRAFT + CONFLICTING (unchanged)",
    recentSessions: [
      {
  ...
  },
  {
    ...
    blockedType: "blocked",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5fa41d32703487a026c9/",
    sessionLabel: "heartbeat 11:00 IDT Jul 14 — #1655 STILL CONFLICTING (cascade chain blocked)",
    recentSessions: [
      {
        sessionId: "019f5fa41d32703487a026c9",
        url: "http://127.0.0.1:3030/ui/s/019f5fa41d32703487a026c9/",
  ...
  },
  {
    ...
    status: "✅ ALL CI GREEN (run 29313871650 — all-checks ✅, e2e-smoke ✅, e2e-api ✅). reviewDecision: APPROVED. MERGEABLE. Awaits #1655 rebase + merge.",
    blockedOn: "Awaiting jn-5867 (#1655) rebase + merge — ordering constraint",
    blockedType: "active",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5fa41d32703487a026c9/",
    sessionLabel: "heartbeat 11:00 IDT Jul 14 — #1657 ALL CI GREEN (APPROVED); awaits #1655",
    recentSessions: [
      {
        sessionId: "019f5fa41d32703487a026c9",
        url: "http://127.0.0.1:3030/ui/s/019f5fa41d32703487a026c9/",
  ...
  },
  {
    ...
    status: "✅ ALL CI GREEN — run 29312738364 COMPLETE. FULLY MERGEABLE. reviewDecision cleared. Can merge now — independent of cascade chain.",
    blockedOn: null,
    blockedType: "active",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5fa41d32703487a026c9/",
    sessionLabel: "heartbeat 11:00 IDT Jul 14 — #1658 ALL CI GREEN, MERGEABLE (unchanged)",
    recentSessions: [
      {
        sessionId: "019f5fa41d32703487a026c9",
        url: "http://127.0.0.1:3030/ui/s/019f5fa41d32703487a026c9/",
  ...
  },
  {
    ...
    status: "🔴 REGRESSION + CONFLICTING — run 29313293534: pre-commit ❌ FAIL (tox modified files), all-checks ❌. CONFLICTING. Was ALL CI GREEN (run 29254605349). Needs fix + new push + rebase.",
    blockedOn: "pre-commit ❌ FAIL + CONFLICTING",
    blockedType: "blocked",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5fa41d32703487a026c9/",
    sessionLabel: "heartbeat 11:00 IDT Jul 14 — #1659 REGRESSION: pre-commit ❌ + CONFLICTING (unchanged)",
    recentSessions: [
      {
        sessionId: "019f5fa41d32703487a026c9",
        url: "http://127.0.0.1:3030/ui/s/019f5fa41d32703487a026c9/",
...
export const MERGED = [
  {
    ...
    note: "Merged 10:48 IDT Jul 14. Off-board PR (no Agor worktree). JN-5879 Jira → needs Done.",
  },
  {
    ticket: "JN-5877",
...
export const ALERTS = [
  ...
  {
    level: "red",
    message: "🔴 #1659 (jn-5868 JN-5868): REGRESSION + CONFLICTING — run 29313293534: pre-commit ❌ FAIL (tox modified files), all-checks ❌. CONFLICTING. Fix: accept tox-modified files, push, rebase.",
  },
  {
    level: "green",
    message: "✅ #1658 (jn-5842 JN-5842): ALL CI GREEN — run 29312738364 COMPLETE. FULLY MERGEABLE. Can merge now (independent of cascade chain).",
  },
  {
    level: "green",
    message: "✅ #1657 (jn-5869 JN-5869): ALL CI GREEN (run 29313871650). reviewDecision: APPROVED. MERGEABLE. Awaits #1655 rebase + merge.",
  },
  {
    level: "yellow",
    message: "🟡 #1638 (JN-5725, off-board): CI run 29315853355 — e2e-api NOW PASSING (was ❌). e2e-smoke ⏳ still pending. MERGEABLE. Significant improvement.",
  },
  {
    level: "green",
    message: "🎉 PR #1665 (JN-5879) MERGED 10:48 IDT Jul 14 — chore(justfile): add helm-dependency-build to pre-commit fast skip list. JN-5879 Jira → needs Done.",
  },
  {
    level: "red",
  ...
  {
    level: "red",
    message: "⚠️ 4 consecutive session failures (19:00+21:00 IDT Jul 13, 03:00+06:00 IDT Jul 14). Daytime sessions 09:00–11:00 IDT Jul 14 all successful. Investigate overnight failure pattern.",
  },
  {
    level: "red",
    message: "🔴 Jira mismatches (7): JN-5879 (NEW), JN-5877, JN-5874, JN-5401, JN-5717, JN-5546, JN-5827 — PRs merged but Jira not Done.",
  },
  {
    level: "yellow",
