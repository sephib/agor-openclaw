export const LAST_UPDATED = "2026-07-23 17:00 IDT";
...
export const WORKTREES = [
  {
    ...
    sessionLabel: "advance heartbeat 17:00 IDT Jul 23 — board static; no merges; no CI changes; 8 Jira mismatches",
    recentSessions: [
      {
    ...
    lastActive: "2026-07-23 17:00 IDT",
  },
  {
    ticket: "AIPCC-27681",
  ...
  },
  {
    ...
    status: "🟡 **MERGEABLE** (conflicts resolved). CI run 29993991860: resolve-conflicts ✅, e2e-api ✅, e2e-smoke ✅, integration ✅, tox ✅, nox ✅, JIRA Assoc ✅, e2e-tests ✅; **pre-commit ❌** still failing. NOT draft. **Action: Fix pre-commit, then ready for review.**",
  ...
  },
  {
    ...
    recentSessions: [
      ...
      },
      {
        ...
        title: "advance heartbeat 12:31 IDT Jul 23 — #1670 still CONFLICTING",
        status: "completed",
      ...
      },
      {
        ...
        title: "advance heartbeat 12:01 IDT Jul 23 — #1670 CONFLICTING; JIRA Assoc fixed run 29921157985",
        status: "completed",
      ...
      },
      {
        ...
        title: "advance heartbeat 11:31 IDT Jul 23 — board static; #1670 CONFLICTING",
        status: "idle",
  ...
  },
  {
    ...
    status: "🆕 **NOT DRAFT** (isDraft:false — un-drafted between 13:01 and 13:31 IDT). MERGEABLE. CI run 29808132144: pre-commit ❌, JIRA Assoc ❌, all-checks ❌; nox ✅, tox ✅. No zone assigned. **Action: Fix pre-commit + JIRA Assoc, assign zone.**",
  ...
  },
  {
    ...
    blockedType: "active",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f8f46bfe972789ee3f244/",
    sessionLabel: "advance heartbeat 17:00 IDT Jul 23 — board static; CI unchanged; atlas-validate ❌+e2e-api ❌ remain",
    recentSessions: [
      {
        sessionId: "019f8f46bfe972789ee3f244",
        url: "http://127.0.0.1:3030/ui/s/019f8f46bfe972789ee3f244/",
...
export const ALERTS = [
  {
    level: "yellow",
    message: "🟡 #1713 (AIPCC-27994): **CI IMPROVED** (run 30008510915) — pre-commit ✅ FIXED (was ❌), JIRA Assoc ✅ FIXED (was ❌); atlas-validate ❌, atlas-validate-run ❌, e2e-api ❌ still failing. **CodeRabbit ✅ COMPLETED**. Action: Fix atlas-validate migration files + investigate e2e-api.",
  },
  {
    level: "red",
  ...
  {
    level: "red",
    message: "🔴 #1638 (JN-5725, off-board): **CI REGRESSION** — Run 29995066495 (09:22 IDT Jul 23) FAILING: pre-commit ❌, e2e-api ❌, e2e-tests ❌, all-checks ❌. Still MERGEABLE. **Action: Investigate failure.**",
  },
  {
    level: "yellow",
    message: "🟡 #1670 (jn-5844 JN-5844): **MERGEABLE**. e2e-smoke ✅ NOW PASSING (was pending at 13:01). **pre-commit ❌** still only blocker. **Action: Fix pre-commit hook.**",
  },
  {
    level: "yellow",
    message: "🟡 #1667 (jn-5845 JN-5845): **MERGEABLE** (conflicts resolved). **pre-commit ❌** still failing. **Action: Fix pre-commit hook failure.**",
  },
  {
    level: "red",
  ...
  {
    level: "red",
    message: "🔴 #1690 (AIPCC-27645): **CONFLICTING** (5+ days unchanged). isDraft:true. All CI 100% passing (run 29729530150). **Action: Rebase aipcc-27645-server-resources on main, mark ready, then request review.**",
  },
  {
    level: "red",
