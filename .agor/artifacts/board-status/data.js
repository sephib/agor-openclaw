export const LAST_UPDATED = "2026-07-13 12:32 IDT";
...
export const WORKTREES = [
  ...
  },
  {
    ...
    sessionLabel: "heartbeat 12:32 IDT Jul 13 — #1656 NOW CONFLICTING (regression)",
    recentSessions: [
      {
  ...
  },
  {
    ...
    blockedType: "blocked",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5acfe9657467940a5076/",
    sessionLabel: "heartbeat 12:32 IDT Jul 13 — run 29238852823 COMPLETE; e2e-api REGRESSION",
    recentSessions: [
      {
        sessionId: "019f5acfe9657467940a5076",
        url: "http://127.0.0.1:3030/ui/s/019f5acfe9657467940a5076/",
  ...
  },
  {
    ...
    blockedType: "blocked",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5acfe9657467940a5076/",
    sessionLabel: "heartbeat 12:32 IDT Jul 13 — run 29238446686 COMPLETE; pre-commit ❌ still",
    recentSessions: [
      {
        sessionId: "019f5acfe9657467940a5076",
        url: "http://127.0.0.1:3030/ui/s/019f5acfe9657467940a5076/",
  ...
  },
  {
    ...
    status: "🟢 CI NOW ALL PASSING (pre-commit ✅, tox ✅, integration ✅, e2e-api ✅, e2e-smoke PENDING). Still CHANGES_REQUESTED from markVaykhansky. MERGEABLE. Address review comments → re-request review.",
    blockedOn: "CHANGES_REQUESTED — address markVaykhansky review before merge",
    blockedType: "active",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5acfe9657467940a5076/",
    sessionLabel: "heartbeat 12:32 IDT Jul 13 — #1658 CI ALL PASSING (new!)",
    recentSessions: [
      {
        sessionId: "019f5acfe9657467940a5076",
        url: "http://127.0.0.1:3030/ui/s/019f5acfe9657467940a5076/",
  ...
  },
  {
    ...
    status: "🔴 NEW CI run 29238209190 COMPLETE — pre-commit ❌ still. e2e-smoke NOW ✅ (was PENDING). tox/integration/e2e-api ✅. Depends on jn-5867 (#1655) merging first.",
    blockedOn: "pre-commit ❌ (run 29238209190) — depends on jn-5867 merge",
    blockedType: "blocked",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5acfe9657467940a5076/",
    sessionLabel: "heartbeat 12:32 IDT Jul 13 — run 29238209190: pre-commit ❌; e2e-smoke ✅ (new)",
    recentSessions: [
      {
        sessionId: "019f5acfe9657467940a5076",
        url: "http://127.0.0.1:3030/ui/s/019f5acfe9657467940a5076/",
...
export const ALERTS = [
  ...
  {
    level: "yellow",
    message: "🟢 #1658 (jn-5842 JN-5842): CI NOW ALL PASSING! Still CHANGES_REQUESTED (markVaykhansky). Address review comments → re-request review.",
  },
  {
    level: "yellow",
    message: "🟡 #1659 (jn-5868 JN-5868): pre-commit ❌ (run 29238209190). e2e-smoke NOW ✅. Depends on jn-5867 merging first.",
  },
  {
    level: "red",
