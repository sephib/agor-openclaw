export const LAST_UPDATED = "2026-07-13 13:00 IDT";
...
export const WORKTREES = [
  ...
  },
  {
    ...
    sessionLabel: "heartbeat 13:00 IDT Jul 13 — #1656 CONFLICTING + DRAFT + pre-commit ❌ (unchanged)",
    recentSessions: [
      {
  ...
  },
  {
    ...
    status: "🔴 REGRESSION: NEW CI run 29238852823 COMPLETE — pre-commit ❌ STILL + e2e-api NOW FAILING (was ✅). tox/integration ✅. REVIEW_REQUIRED. Cascade blocker getting worse.",
    blockedOn: "pre-commit ❌ + e2e-api ❌ (run 29238852823 — regression)",
    blockedType: "blocked",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5aeb60f67e00a6c91cdd/",
    sessionLabel: "heartbeat 13:00 IDT Jul 13 — #1655 run 29238852823 unchanged; cascade blocker",
    recentSessions: [
      {
        sessionId: "019f5aeb60f67e00a6c91cdd",
        url: "http://127.0.0.1:3030/ui/s/019f5aeb60f67e00a6c91cdd/",
        title: "heartbeat 13:00 IDT Jul 13 — run 29238852823 unchanged: pre-commit ❌ + e2e-api ❌",
        status: "completed",
        timestamp: "2026-07-13 13:00 IDT",
        outputFile: null,
      },
      {
        sessionId: "019f5acfe9657467940a5076",
        url: "http://127.0.0.1:3030/ui/s/019f5acfe9657467940a5076/",
        title: "heartbeat 12:32 IDT Jul 13 — run 29238852823: pre-commit ❌ + e2e-api ❌ (REGRESSION)",
        status: "idle",
        timestamp: "2026-07-13 12:32 IDT",
        outputFile: null,
      },
  ...
  },
  {
    ...
    status: "🔴 NEW CI run 29238446686 COMPLETE — pre-commit ❌ STILL. e2e-api ✅, e2e-smoke ✅. UNKNOWN mergeable (was CONFLICTING). Fix pre-commit.",
    blockedOn: "pre-commit ❌ (run 29238446686)",
    blockedType: "blocked",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5aeb60f67e00a6c91cdd/",
    sessionLabel: "heartbeat 13:00 IDT Jul 13 — run 29238446686 unchanged: pre-commit ❌",
    recentSessions: [
      {
        sessionId: "019f5aeb60f67e00a6c91cdd",
        url: "http://127.0.0.1:3030/ui/s/019f5aeb60f67e00a6c91cdd/",
        title: "heartbeat 13:00 IDT Jul 13 — #1657 run 29238446686 unchanged: pre-commit ❌",
        status: "completed",
        timestamp: "2026-07-13 13:00 IDT",
        outputFile: null,
      },
      ...
      },
      {
        sessionId: "019f5ab471db71b9a99f6a9c",
        url: "http://127.0.0.1:3030/ui/s/019f5ab471db71b9a99f6a9c/",
        title: "heartbeat 12:02 IDT Jul 13 — #1657 NOW CONFLICTING (regression)",
        status: "idle",
        timestamp: "2026-07-13 12:02 IDT",
        outputFile: null,
      },
  ...
  },
  {
    ...
    blockedType: "active",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5aeb60f67e00a6c91cdd/",
    sessionLabel: "heartbeat 13:00 IDT Jul 13 — #1658 CI FULLY GREEN (e2e-smoke ✅ confirmed)",
    recentSessions: [
      {
        sessionId: "019f5aeb60f67e00a6c91cdd",
        url: "http://127.0.0.1:3030/ui/s/019f5aeb60f67e00a6c91cdd/",
  ...
  },
  {
    ...
    status: "🟡 NEW CI run 29241018713 PENDING. e2e-api ✅, integration ✅ early. pre-commit/tox/e2e-smoke still running. MERGEABLE. Depends on jn-5867 (#1655) merging first.",
    blockedOn: "CI PENDING (run 29241018713) — depends on jn-5867 merge",
    blockedType: "active",
    sessionUrl: "http://127.0.0.1:3030/ui/s/019f5aeb60f67e00a6c91cdd/",
    sessionLabel: "heartbeat 13:00 IDT Jul 13 — #1659 NEW CI run 29241018713 PENDING",
    recentSessions: [
      {
        sessionId: "019f5aeb60f67e00a6c91cdd",
        url: "http://127.0.0.1:3030/ui/s/019f5aeb60f67e00a6c91cdd/",
        title: "heartbeat 13:00 IDT Jul 13 — #1659 NEW CI run 29241018713 PENDING (e2e-api ✅ early)",
        status: "completed",
        timestamp: "2026-07-13 13:00 IDT",
        outputFile: null,
      },
...
export const ALERTS = [
  ...
  {
    level: "red",
    message: "🔴 #1655 (jn-5867 JN-5867): REGRESSION — NEW CI run 29238852823: pre-commit ❌ + e2e-api ❌ (was ✅). Cascade blocker getting worse. Fix both failures.",
  },
  {
    level: "red",
    message: "🔴 #1656 (jn-5870 JN-5870): NOW CONFLICTING (was MERGEABLE). DRAFT + pre-commit ❌. Rebase + fix pre-commit + undraft.",
  },
  {
    level: "red",
    message: "🔴 #1657 (jn-5869 JN-5869): pre-commit ❌ STILL (run 29238446686). Fix pre-commit.",
  },
  {
    level: "yellow",
    message: "🟢 #1658 (jn-5842 JN-5842): CI FULLY GREEN (run 29238532071 — all-checks ✅ incl e2e-smoke)! Still CHANGES_REQUESTED (markVaykhansky). Address review comments → re-request review.",
  },
  {
    level: "yellow",
    message: "🟡 #1659 (jn-5868 JN-5868): NEW CI run 29241018713 PENDING. e2e-api ✅ early. Depends on jn-5867 merging first. Monitor result.",
  },
  {
    level: "red",
    message: "🔴 Jira mismatches (5): JN-5874 (NEW), JN-5401, JN-5717, JN-5546, JN-5827 — PRs merged but Jira not Done.",
  },
  {
    level: "yellow",
  ...
  {
    level: "yellow",
    message: "🟡 PR #1638 (JN-5725, off-board): NEW run 29239468257 IMPROVED — pre-commit ✅, tox ✅, e2e-api ✅, e2e-smoke ✅. e2e-product PENDING (was ❌). Await result.",
  },
  {
    level: "red",
